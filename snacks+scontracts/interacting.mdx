...
After successful deployment, Forge will output the contract's address. Save this address as you'll need it for future interactions!
...
Put this into [Sepolia Ether Scan](https://ethereum-sepolia-rpc.publicnode.com/) to analyze the transaction.
