...
```math
2^{256} or \space \text{possibilities} \space or \space 1.1579209 \times 10^{77} \space  \text{combinations}
```
...
To put that into perspective, the odds you win the Powerball lottery about 1 in 292 million. Meaning you are 3.98 x 10^68 times more likely to win the lottery than it is to guess a seed phrase.
